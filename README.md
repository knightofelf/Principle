...
<pre>
01000   00010  진법 비트 시프트  E=MC^2 빛과 그림자 객체 Procedure 생명 순환 Half Open 
01 101 1000011110011  비트 엔터
N + N + N = S    N진법 바구니 담기
bit + bit + bit  =  비트 = 껍질 + 알맹이. (ms sseal 카프리카 수 지뢰찾기 로마숫자)
...
데이터 가청화 시각화 (사운드 블래스터)
SubClassing Color Change Fast
HDC 0 메모리
마스게임 카드섹션 - 다중 병렬 처리 <—- 반대로 —-> 이미지 검색 GAN 영상 인식 (등가교환)
if ( ) 방정식rom’이 어려워. 함수ram’ 사용 
Drag & Drop - New  Challenge - Next Time   23.5도 기운 지구 . 1시간 15도
